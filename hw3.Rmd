...
The confusion matrices show the results on the test data which can be used to calculate an accuracy score. However, to build a more robust estimate of each model's accuracy, we will bootstrap the result by directly calling the `resamples()` function
