...
2. **Sex** - sex is given as a binary feature and is not equally balanced with 57% Male and 43% Female
3. **Race** - race takes one of four values: 'White' (41%), 'African American' (57%), 'Hispanic'(.6%) and 'Other or Missing Data'(1%).
